          ...
          <div className="embla__controls !mt-[-24px]">
            <div className="embla__buttons">
              <button 
                ...
                className="group/button relative group/button rounded-full flex transition-colors border-0 bg-PC-Primary text-PC-TextWhite hover:bg-PC-PrimaryLight m-2 aspect-square w-10 items-center justify-center"
              >
