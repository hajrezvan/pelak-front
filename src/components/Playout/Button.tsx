...
const UIs = {
  primary: "bg-PC-Primary hover:bg-PC-PrimaryDark    text-PC-White",
  secondary: "bg-PC-Secondary hover:bg-PC-SecondaryDark    text-PC-White",
  success: "bg-PC-Success hover:bg-PC-SuccessDark    text-PC-White",
  error: "bg-PC-Error hover:bg-PC-ErrorDark    text-PC-White",
...
export default function Button({
  ...
  const baseStyles = "flex items-center    px-PC-3 py-PC-2    rounded-PC-2    transition";
  ...
  if (href && !disabled) {
    ...
    return (
      <LinkComponent
        href={href}
        className={baseStyles + " " + iconStyles[align] + " " + (disabled ? UIs.disabled : UIs[UI]) + " " + className}
        title={title}
        svgIcon={svgIcon}
  ...
  return (
    <ButtonComponent
      className={baseStyles + " " + iconStyles[align] + " " + (disabled ? UIs.disabled : UIs[UI] + " " + "cursor-pointer") + " " + className}
      title={title}
      svgIcon={svgIcon}
      svgIconClassName={svgIconClassName}
      svgIconSize={svgIconSize}
