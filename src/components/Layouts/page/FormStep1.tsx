    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 border border-P-BackgroundBorder rounded-md focus:outline-none focus:ring-2 focus:ring-P-Primary"
          placeholder="Enter your name"
        />
        {errors.name && <p className="text-P-Error text-sm mt-1">{errors.name}</p>}
      </div>
      ...
      <div>
        ...
        />
        {errors.email && <p className="text-P-Error text-sm mt-1">{errors.email}</p>}
      </div>
      ...
      <div>
        ...
        />
        {errors.phone && <p className="text-P-Error text-sm mt-1">{errors.phone}</p>}
      </div>

      {/* Contact Methods */}
      <div>
        <label className="block text-sm font-medium text-P-Text mb-2">
        ...
        {errors.contactMethods && <p className="text-P-Error text-sm mt-1">{errors.contactMethods}</p>}
      </div>
