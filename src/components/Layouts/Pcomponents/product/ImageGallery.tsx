                    ...
                    `}>
							{item.map((image) => (
								...
								>
									...
									<span
										aria-hidden="true"
										className="pointer-events-none absolute inset-0 sm:rounded-md ring-2 ring-PC-BackgroundBorder ring-offset-2 ring-offset-PC-Background group-data-selected:ring-PC-Primary"
									/>
								</Tab>
							))}
						</TabList>
